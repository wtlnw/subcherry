...
public class DefaultLocalMkDir extends DefaultTargetCommand implements LocalMkDir {

	public DefaultLocalMkDir(OperationFactory factory) {
		super(factory);
	}

	@Override
	public String toString() {
		return "svn mkdir " + getTarget();
	}

	@Override
	public <R, A> R visit(CommandVisitor<R, A> v, A arg) {
		return v.visitLocalMkDir(this, arg);
	}
